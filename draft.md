...
On the distinctions between "user threads" or "user-space threads" and "kernel threads", the [History section of the Wikipedia entry `Thread_(computing)#History` has this to say:
